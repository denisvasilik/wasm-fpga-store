...
set project_name "WasmFpgaStore"
...
set files_vhd [list \
 ...
 [file normalize "${project_src_gen}/vhd_gen/header/wasm_fpga_store_header.vhd" ]\
 [file normalize "${project_src_gen}/vhd_gen/wishbone/wasm_fpga_store_wishbone.vhd" ]\
...
set obj [get_filesets sources_1]
set_property -name "top" -value "WasmFpgaStore" -objects $obj
set_property -name "top_auto_set" -value "0" -objects $obj
set_property -name "top_file" -value "${project_src}/WasmFpgaStore.vhd" -objects $obj
...
set files [list \
 "[file normalize "${project_tb}/tb_WasmFpgaStore.vhd"]"\
...
set obj [get_filesets sim_1]
set_property "top" "tb_WasmFpgaStore" $obj
